...
docker buildx build --platform linux/amd64,linux/arm64 \
  -t tonovarela/ventas-export:1.0.2 \
  -t tonovarela/ventas-export:latest \
  --push .
docker buildx imagetools inspect tonovarela/ventas-export:1.0.2   # debe listar linux/amd64 y linux/arm64
```
...
docker pull tonovarela/ventas-export:1.0.2
```
...
0 23 * * 0  /usr/bin/docker run --rm --env-file /opt/ventas-export/.env -v /opt/ventas-export/output:/app/output tonovarela/ventas-export:1.0.2 >> /opt/ventas-export/cron.log 2>&1
```
